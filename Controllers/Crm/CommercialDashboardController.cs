...
[ApiController]
[Route("api/crm/dashboard/commercial")]
public sealed class CommercialDashboardController : ControllerBase
{
    private readonly ICommercialDashboardService _service;

    public CommercialDashboardController(ICommercialDashboardService service)
    {
        _service = service;
    }
